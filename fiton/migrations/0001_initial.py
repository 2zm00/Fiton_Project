# Generated by Django 5.1.3 on 2024-12-16 01:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fit_time', models.TimeField(blank=True, null=True, verbose_name='운동 시간')),
            ],
        ),
        migrations.CreateModel(
            name='Center',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_type', models.CharField(verbose_name='수업 종류')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='class_ticket', to='fiton.class', verbose_name='수업')),
            ],
        ),
        migrations.CreateModel(
            name='Instructor',
            fields=[
                ...
                ('center', models.ManyToManyField(blank=True, null=True, related_name='instructor', to='fiton.center', verbose_name='등록된 센터')),
            ],
        ),
        migrations.AddField(
            model_name='class',
            name='instructor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='classes', to='fiton.instructor', verbose_name='강사'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('reserved', '예약됨'), ('Waiting for the reservation', '예약대기중'), ('reservation canceled', '예약취소')], default='reserved', max_length=50, verbose_name='상태')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('member', '수강생'), ('instructor', '강사'), ('director', '센터장')], default='student', max_length=20, verbose_name='역할')),
        ...
        migrations.AddField(
            model_name='member',
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='fiton.user', verbose_name='사용자'),
        ),
        migrations.AddField(
